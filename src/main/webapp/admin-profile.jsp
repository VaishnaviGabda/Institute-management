				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-user"></i>Admin Profile</h5>
										...
										<div class="dash-form">
											<table class="table table">
												<tbody>
													<tr>
														<td>
															<label class="clear-top-margin"><i class="fa fa-id-card"></i>ADMIN ID</label>
															<input type="text" placeholder="First Name" disabled/>
														</td>
													</tr>
													<tr>
														<td>
															<label class="clear-top-margin"><i class="fa fa-user"></i>ADMIN NAME</label>
															<input type="text" placeholder="Last Name" disabled/>
														</td>
													</tr>
													<tr>
														<td>
                                                            <label><i class="fa fa-phone"></i>ADMIN PHONE #</label>
															<input type="text" placeholder="1234567890" disabled/>
														</td>
													</tr>
													<tr>
														<td>
															<label><i class="fa fa-envelope"></i>ADMIN E-MAIL ID</label>
															<input type="text" placeholder="abc@gmail.com" disabled/>
														</td>
													</tr>
                                                    <tr>
														<td>
															<label><i class="fa fa-key"></i>ADMIN PASSWORD</label>
															<input type="text" placeholder="abc@gmail.com" disabled/>
														</td>
													</tr>
												</tbody>
