...
<html>
	...
	<head>
	    ...
	    { 
	        ...
	        {
	        	  var data="Examiner Name Should Contain Letters Only";
	              e.innerHTML=data;
	              return false;
	        }          
	    }
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs" style="padding-top:0;">
							<h5 class="page-title">Welcome Examiner Please Register Here</h5>
								...
								<div class="dash-item first-dash-item">
									<div class="inner-item" style="margin-top:0;padding-top:0;">
										<form class="dash-form" name="form1">
                                            ...
                                            <label class="clear-top-margin"><i class="fa fa-book"></i>Examiner Name</label>
											<input type="text" placeholder="Enter Examiner Name Here" name="text2" onblur="allLetter(document.form1.text2)"/>
											<span id="Name1" style="color:red;"></span><br><br>

                                            <label class="clear-top-margin"><i class="fa fa-book"></i>Examiner E-mail Id</label>
											<input type="text" placeholder="Enter Examiner Email-Id Here" name="text3" onblur="ValidateEmail(document.form1.text3)"/>
											<span id="email" style="color:red;"></span><br><br>

                                            <label class="clear-top-margin"><i class="fa fa-book"></i>Examiner Mobile Number</label>
											<input type="text" placeholder="Enter Examiner Mobile Number Here" name="text4" onblur="phonenumber(document.form1.text4)" />
											<span id="phNo" style="color:red;"></span><br><br>

											<label class="clear-top-margin"><i class="fa fa-book"></i>Password</label>
											<input type="text" placeholder="Enter Examiner Password Here" name="text5" onblur="passwordvalid(document.form1.text5)"/>
