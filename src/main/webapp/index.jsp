				...
				<ul class="top-nav-list">
					...
					<li class="user dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<span><img src="assets/img/parent/parent2.jpg" alt="user">Choose User<span class="caret"></span></span>
						</a>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<table class="table table-light" id="feature_table">
								<tbody>
									<tr>
										<td>Feature 1</td><td>Feature 1</td><td>Feature 1</td><td>Feature 1</td>
									</tr>
									<tr>
										<td>Feature 1</td><td>Feature 1</td><td>Feature 1</td><td>Feature 1</td>
									</tr>
