	...
	<head>
		...
		function allnumeric(inputtxt)
	    {
			var e = document.getElementById("adminId");
		      ...
		      {
		    	  var data="Please Enter Valid Admin Id";
                  e.innerHTML=data;
		           return false;
		      }
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title">Welcome Admin Please Login Here</h5>
								...
								<div class="dash-item first-dash-item">
									<div class="inner-item">
										<form class="dash-form" name="form1">
											<label class="clear-top-margin"><i class="fa fa-book"></i>Admin Id</label>
											<input type="text" placeholder="Enter Admin Id Here" name="text1" onblur="allnumeric(document.form1.text1)"/>
											<span id="adminId" style="color:red;"></span><br><br>

											<label class="clear-top-margin"><i class="fa fa-book"></i>Admin Password</label>
											<input type="text" placeholder="Enter Admin Password Here" name="text2" onblur="passwordvalid(document.form1.text2)"/>
											<span id="adminPass" style="color:red;"></span>

											<div>
												<a href="adminDashboard.jsp"><i class="fa fa-paper-plane"></i> Login</a>
											</div>
										</form>
									</div>
								</div>
