				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title">Welcome Student Please Login Here</h5>
								...
								<div class="dash-item first-dash-item">
									<div class="inner-item">
										<form class="dash-form" name="form1">
											<label class="clear-top-margin"><i class="fa fa-book"></i>Student Id</label>
											<input type="text" placeholder="Enter Student Id Here" name="text1" onblur="allnumeric(document.form1.text1)"/>
											<span id="studId" style="color:red;"></span><br><br>

											<label class="clear-top-margin"><i class="fa fa-book"></i>Student Password</label>
											<input type="text" placeholder="Enter Student Password Here" name="text2" onblur="passwordvalid(document.form1.text2)"/>
											<span id="studPass" style="color:red;"></span>

											<div>
												<a href="studentDashboard.jsp"><i class="fa fa-paper-plane"></i> Login</a>
                                                <a href="studentRegistration.jsp"><i class="fa fa-paper-plane"></i> Register</a>
											</div>
										</form>
									</div>
								</div>
