				...
				<ul class="top-nav-list">
					...
					<li class="user dropdown">
						...
						<ul class="dropdown-menu notification-list">
							<li>
								<a href="student/student-profile.jsp"><i class="fa fa-users"></i> USER PROFILE</a>
							</li>
							<li>
								<a href="student/student-change-pass.jsp"><i class="fa fa-key"></i> CHANGE PASSWORD</a>
							</li>
							<li>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-sliders"></i>your COURSES</h5>
						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-sm-12">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-sliders"></i>ALL COURSES</h6>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body dash-form">
								...
								<div class="col-sm-4">
									<label class="clear-top-margin"><i class="fa fa-code"></i>COURSE CODE</label>
